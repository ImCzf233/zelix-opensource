...
public class WForgeBlockModelRenderer extends ForgeBlockModelRenderer
{
    ...
    public boolean func_178267_a(final IBlockAccess blockAccessIn, final IBakedModel modelIn, final IBlockState blockStateIn, final BlockPos blockPosIn, final BufferBuilder buffer, boolean checkSides) {
