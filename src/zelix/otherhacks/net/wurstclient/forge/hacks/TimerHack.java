...
public final class TimerHack extends Hack
{
    ...
    private void setTickLength(final float tickLength) {
        try {
            final Field fTimer = TimerHack.mc.getClass().getDeclaredField(TimerHack.wurst.isObfuscated() ? "field_71428_T" : "timer");
            ...
            if ("1.12.2".equals("1.10.2")) {
                ...
                final Field fTickLength = Timer.class.getDeclaredField(TimerHack.wurst.isObfuscated() ? "field_194149_e" : "tickLength");
