...
public final class MobEspHack extends Hack
{
    ...
    public void onUpdate(final WUpdateEvent event) {
        ...
        this.mobs.clear();
        Stream<EntityLiving> stream = (Stream<EntityLiving>)world.loadedEntityList.parallelStream().filter(e -> e instanceof EntityLiving).map(e -> e).filter(e -> !e.isDead && e.func_110143_aJ() > 0.0f);
