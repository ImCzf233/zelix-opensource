...
public final class PlayerControllerUtils
{
    ...
    public static float getCurBlockDamageMP() throws ReflectiveOperationException {
        final Field field = PlayerControllerMP.class.getDeclaredField(PlayerControllerUtils.wurst.isObfuscated() ? "field_78770_f" : "curBlockDamageMP");
    ...
    public static void setBlockHitDelay(final int blockHitDelay) throws ReflectiveOperationException {
        final Field field = PlayerControllerMP.class.getDeclaredField(PlayerControllerUtils.wurst.isObfuscated() ? "field_78781_i" : "blockHitDelay");
        field.setAccessible(true);
    ...
    public static void setIsHittingBlock(final boolean isHittingBlock) throws ReflectiveOperationException {
        final Field field = PlayerControllerMP.class.getDeclaredField(PlayerControllerUtils.wurst.isObfuscated() ? "field_78778_j" : "isHittingBlock");
        field.setAccessible(true);
