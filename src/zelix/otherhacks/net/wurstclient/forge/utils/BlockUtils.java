...
public final class BlockUtils
{
    ...
    public static AxisAlignedBB getBoundingBox(final BlockPos pos) {
        return getState(pos).func_185900_c((IBlockAccess)WMinecraft.getWorld(), pos).offset(pos);
    }
    ...
    public static float getHardness(final BlockPos pos) {
        return getState(pos).func_185903_a((EntityPlayer)WMinecraft.getPlayer(), (World)WMinecraft.getWorld(), pos);
    }
    ...
    public static void placeBlockSimple(final BlockPos pos) {
        ...
        try {
            final Field rightClickDelayTimer = BlockUtils.mc.getClass().getDeclaredField(ForgeWurst.getForgeWurst().isObfuscated() ? "field_71467_ac" : "rightClickDelayTimer");
    ...
    public static boolean breakBlockSimple(final BlockPos pos) {
        ...
        final EnumFacing[] sides = EnumFacing.values();
        final Vec3d eyesPos = RotationUtils.getEyesPos();
        final Vec3d relCenter = getState(pos).func_185900_c((IBlockAccess)WMinecraft.getWorld(), pos).getCenter();
