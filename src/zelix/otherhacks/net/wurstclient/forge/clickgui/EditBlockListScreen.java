...
public final class EditBlockListScreen extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.func_73732_a(WMinecraft.getFontRenderer(), this.blockList.getName() + " (" + this.listGui.getSize() + ")", this.width / 2, 12, 16777215);
        ...
        if (this.blockNameField.getText().isEmpty() && !this.blockNameField.isFocused()) {
            this.func_73731_b(WMinecraft.getFontRenderer(), "block name or ID", 68, this.height - 50, 8421504);
        }
        func_73734_a(48, this.height - 56, 64, this.height - 36, -6250336);
        func_73734_a(49, this.height - 55, 64, this.height - 37, -16777216);
        func_73734_a(214, this.height - 56, 244, this.height - 55, -6250336);
        func_73734_a(214, this.height - 37, 244, this.height - 36, -6250336);
        func_73734_a(244, this.height - 56, 246, this.height - 36, -6250336);
        func_73734_a(214, this.height - 55, 243, this.height - 52, -16777216);
        func_73734_a(214, this.height - 40, 243, this.height - 37, -16777216);
        func_73734_a(215, this.height - 55, 216, this.height - 37, -16777216);
        func_73734_a(242, this.height - 55, 245, this.height - 37, -16777216);
