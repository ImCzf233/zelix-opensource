...
public class KendallSIlder extends Component
{
    ...
    public void render(final float x, final float y, final int mouseX, final int mouseY) {
        ...
        final float range = (float)(Object)this.value.getMax() - (float)(Object)this.value.getMin();
        final float precent = range / 100.0f;
        this.per = (int)(((float)(Object)this.value.getValue() - (float)(Object)this.value.getMin()) / precent);
