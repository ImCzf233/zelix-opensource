...
public class Slider extends Component
{
    ...
    public void renderComponent() {
        ...
        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.set.getRenderName() + ": " + ((Value<Object>)this.set).getValue(), (float)(this.parent.parent.getX() * 2 + 15), (float)((this.parent.parent.getY() + this.offset - 1) * 2 + 5), -1);
        GL11.glPopMatrix();
    }
