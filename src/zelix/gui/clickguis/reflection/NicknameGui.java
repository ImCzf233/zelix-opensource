...
public class NicknameGui extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.func_73732_a(this.fontRenderer, "Username Changer", this.width / 2, 17, 16777215);
        this.func_73731_b(this.fontRenderer, "Nickname:", this.width / 2 - 100, this.width / 2 - 180, 10526880);
