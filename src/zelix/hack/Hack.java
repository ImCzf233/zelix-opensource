...
public class Hack
{
    ...
    public void onEnable() {
        MsgUtils.sendNotification(this.getName(), 0);
    }
    
    public void onDisable() {
        MsgUtils.sendNotification(this.getName(), 1);
    }
    ...
    public void onRenderGameOverlay(final RenderGameOverlayEvent.Text event) {
        MsgUtils.INSTANCE.drawNotifications();
    }
    ...
    public void onCameraSetupS(final EntityViewRenderEvent.CameraSetup event) {
    }
