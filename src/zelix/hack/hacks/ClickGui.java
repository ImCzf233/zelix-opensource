...
public class ClickGui extends Hack
{
    ...
    public ClickGui() {
        ...
        ClickGui.scaleValue = new NumberValue("scaleValue", 1.0, 0.7, 2.0);
        this.addValue(this.theme, ClickGui.language, ClickGui.tooltip, ClickGui.shadow, ClickGui.rainbow, ClickGui.red, ClickGui.green, ClickGui.blue, ClickGui.alpha, ClickGui.scaleValue);
        setColor();
    }
    ...
    public static void setColor() {
        ClickGui.color = ColorUtils.color((int)(Object)ClickGui.red.getValue(), (int)(Object)ClickGui.green.getValue(), (int)(Object)ClickGui.blue.getValue(), (int)(Object)ClickGui.alpha.getValue());
    }
