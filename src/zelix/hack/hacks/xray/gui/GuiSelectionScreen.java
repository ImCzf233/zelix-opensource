...
public class GuiSelectionScreen extends GuiBase
{
    ...
    private void updateSearch() {
        ...
        this.itemList = this.originalList.stream().filter(b -> b.getEntryName().toLowerCase().contains(this.search.getText().toLowerCase())).collect((Collector<? super Object, ?, ArrayList<BlockData>>)Collectors.toCollection((Supplier<R>)ArrayList::new));
