...
public class GuiSlider extends GuiButton
{
    ...
    protected void mouseDragged(final Minecraft par1Minecraft, final int par2, final int par3) {
        ...
        this.func_73729_b(this.x + (int)(this.sliderValue * (this.width - 8)), this.y, 0, 66, 4, 20);
        this.func_73729_b(this.x + (int)(this.sliderValue * (this.width - 8)) + 4, this.y, 196, 66, 4, 20);
    }
