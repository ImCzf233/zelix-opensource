...
public class Reach extends Hack
{
    ...
    public static Object[] getMouseOver(final double Range, final double bbExpand, final float f) {
        ...
        Wrapper.INSTANCE.mc().profiler.startSection("pick");
        ...
        final Vec3d vector = positionEyes.add(renderViewEntityLook.x * Range, renderViewEntityLook.y * Range, renderViewEntityLook.z * Range);
        Vec3d ve = null;
        final List entitiesWithinAABB = Wrapper.INSTANCE.world().getEntitiesWithinAABBExcludingEntity(renderViewEntity, renderViewEntity.getEntityBoundingBox().expand(renderViewEntityLook.x * Range, renderViewEntityLook.y * Range, renderViewEntityLook.z * Range).expand(1.0, 1.0, 1.0));
        double range = Range;
        ...
        Wrapper.INSTANCE.mc().profiler.endSection();
