...
public class AimAssist extends Hack
{
    ...
    public void onPlayerEventPre(final EventPlayerPre event) {
        if (this.target.isDead || !this.target.isEntityAlive() || this.target.getHealth() <= 0.0f) {
            this.target = null;
        }
    }
