...
public class RenderUtils
{
    ...
    public static void drawCircle(final Entity entity, final double rad) {
        GL11.glDisable(3553);
        GL11.glLineWidth(1.0f);
        GL11.glBegin(3);
        final double x = entity.lastTickPosX + (entity.posX - entity.lastTickPosX) * 0.1 - GuiClickShell.mc.getRenderManager().viewerPosX;
        final double y = entity.lastTickPosY + (entity.posY - entity.lastTickPosY) * 0.1 - GuiClickShell.mc.getRenderManager().viewerPosY + Wrapper.INSTANCE.player().getEyeHeight() - 0.8;
        final double z = entity.lastTickPosZ + (entity.posZ - entity.lastTickPosZ) * 0.1 - GuiClickShell.mc.getRenderManager().viewerPosZ;
        for (int i = 0; i <= 90; ++i) {
    ...
    public static void drawCircle(final Entity entity, final double rad, final int color, final boolean shade) {
        ...
        GL11.glBegin(5);
        final double x = entity.lastTickPosX + (entity.posX - entity.lastTickPosX) - GuiClickShell.mc.getRenderManager().viewerPosX;
        final double y = entity.lastTickPosY + (entity.posY - entity.lastTickPosY) - GuiClickShell.mc.getRenderManager().viewerPosY + Math.sin(System.currentTimeMillis() / 200.0) + 1.0;
        final double z = entity.lastTickPosZ + (entity.posZ - entity.lastTickPosZ) - GuiClickShell.mc.getRenderManager().viewerPosZ;
