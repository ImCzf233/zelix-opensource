    ...
    public static void setReach(final Entity entity, final double range) {
        ...
        if (player == entity) {
            ...
            if (!(Wrapper.INSTANCE.mc().playerController instanceof RangePlayerController)) {
                final GameType gameType = (GameType)ReflectionHelper.getPrivateValue((Class)PlayerControllerMP.class, (Object)Wrapper.INSTANCE.mc().playerController, new String[] { Mapping.currentGameType });
                final NetHandlerPlayClient netClient = (NetHandlerPlayClient)ReflectionHelper.getPrivateValue((Class)PlayerControllerMP.class, (Object)Wrapper.INSTANCE.mc().playerController, new String[] { Mapping.connection });
