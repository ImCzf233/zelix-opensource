...
public class AStarCustomPathFinder
{
    ...
    public AStarCustomPathFinder(final Vec3d startVec3, final Vec3d endVec3) {
        ...
        this.nearest = true;
        this.startVec3 = startVec3.add(0.0, 0.0, 0.0);
        this.endVec3 = endVec3.add(0.0, 0.0, 0.0);
    }
    ...
    Label_0330:
        for (int i = 0; i < loops; ++i) {
            ...
            for (final Hub hub : new ArrayList<Hub>(this.hubsToWork)) {
                ...
                final Vec3d loc2 = hub.getLoc().add(0.0, 1.0, 0.0);
                if (checkPositionValidity(loc2, false) && this.addHub(hub, loc2, 0.0)) {
                    break Label_0330;
                }
                final Vec3d loc3 = hub.getLoc().add(0.0, -1.0, 0.0);
