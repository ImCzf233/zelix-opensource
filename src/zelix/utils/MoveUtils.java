...
public class MoveUtils
{
    ...
    public static float[] getRotationsBlock(final BlockPos block, final EnumFacing face) {
        final double x = block.getX() + 0.5 - Wrapper.INSTANCE.mc().player.posX + face.getXOffset() / 2.0;
        final double z = block.getZ() + 0.5 - Wrapper.INSTANCE.mc().player.posZ + face.getZOffset() / 2.0;
